    ...
    <div class="list-container">
        ...
        <div class="list-header">
            <div class="list-title">
                <h3>Blood Groups ({{ $bloodGroups->total() }})</h3>
            </div>
            <div class="list-actions">
                <!-- Search and Sort in one line -->
                <form method="GET" action="{{ route('blood-groups.index') }}" class="filter-row">
                    ...
                    <a href="{{ route('blood-groups.create') }}" class="btn btn-add">
